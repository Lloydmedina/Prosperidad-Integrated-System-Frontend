...
@Component({
  selector: 'app-aics-print-list',
  templateUrl: './aics-print-list.component.html',
  styleUrls: ['./aics-print-list.component.scss']
})
export class AicsPrintListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.aicsService.getAicsGenerated(this.filterValue.filter_type, this.localStorageStatus, this.localStorageDeletedStatus, this.filterValue.thisMonth, this.filterValue.thisYear, this.filterValue.monthly, this.filterValue.monthlyYear, this.filterValue.yearQuarterly, this.filterValue.quarter, this.filterValue.yearly, this.filterValue.from, this.filterValue.to).subscribe(data => {
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "Aics_List_Worksheet.xlsx";
