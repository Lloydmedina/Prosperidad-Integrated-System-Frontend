...
@Component({
  selector: 'app-dafac-intake-print-form',
  templateUrl: './dafac-intake-print-form.component.html',
  styleUrls: ['./dafac-intake-print-form.component.scss']
})
export class DafacIntakePrintFormComponent implements OnInit {
  ...
  ngOnInit() {
    this.dafacIntakeService.getDafacIntakeEdit(this.param).subscribe(data => {
      this.data = data;
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "DAFACIntake_Form_Worksheet.xlsx";
