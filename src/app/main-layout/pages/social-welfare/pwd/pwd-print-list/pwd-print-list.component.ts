...
@Component({
  selector: 'app-pwd-print-list',
  templateUrl: './pwd-print-list.component.html',
  styleUrls: ['./pwd-print-list.component.scss']
})
export class PwdPrintListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.pwdService.getPwdGenerated(this.filterValue.filter_type, this.localStorageStatus, this.localStorageDeletedStatus, this.filterValue.thisMonth, this.filterValue.thisYear, this.filterValue.monthly, this.filterValue.monthlyYear, this.filterValue.yearQuarterly, this.filterValue.quarter, this.filterValue.yearly, this.filterValue.from, this.filterValue.to).subscribe(data => {
