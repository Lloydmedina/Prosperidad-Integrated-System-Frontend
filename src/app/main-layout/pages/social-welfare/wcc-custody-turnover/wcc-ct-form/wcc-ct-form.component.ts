...
import { AnteMortemComponent } from '../../../econ-enterprise/slaughterhouse/ante-mortem/ante-mortem.component';


@Component({
  selector: 'app-wcc-ct-form',
  templateUrl: './wcc-ct-form.component.html',
  styleUrls: ['./wcc-ct-form.component.scss']
})
export class WccCtFormComponent implements OnInit {
  ...
  constructor(
    ...
    private tocService : WccTurnover_ofcustodyService
...
upData : any [] = [];
  loadDataForUpdate(tid : string){
    ...
    this.tocService.getData(tid).subscribe(data =>{
      ...
      wtnsS.forEach((wtnsS_data : any)=>{
        this.witnessArray().push(
          this.fb.group({
            wcc_toc_witness_pid : wtnsS_data.wcc_toc_pkid,
            wcc_toc_witness_pname : wtnsS_data.wcc_toc_witness_pname,
            wcc_toc_witness_paddress : wtnsS_data.wcc_toc_witness_paddress,
            wcc_toc_witness_relation : wtnsS_data.wcc_toc_witness_relation,
            wcc_toc_witness_familyid : wtnsS_data.wcc_toc_witness_family_id,
          })
        )
      });
    });
    ...
    //console.log("person data",this.personData);
      ...
      witnessFields(data : any) : FormGroup{
        return this.fb.group({
          wcc_toc_witness_pid : "",
          wcc_toc_witness_pname : "",
          wcc_toc_witness_paddress : "",
          wcc_toc_witness_relation : "",
          wcc_toc_witness_familyid : "",
        });
      }
      //INITIATE ARRAY-----------
...
showPersonList(e? : MouseEvent) :void {
  ...
  drawerRef.afterClose.subscribe(data => {
    if (data != null) {
      ...
      this.witnessArray().push(
        this.fb.group({
          wcc_toc_witness_pid : data.person_guid,
          wcc_toc_witness_pname : data.first_name+" "+data.middle_name+" "+data.last_name+" "+data.suffix,
          wcc_toc_witness_paddress : data.street == null ? data.brgy_name+", "+data.city_mun_name+", "+data.province_name : data.brgy_name+", "+data.city_mun_name+", "+data.province_name,
          wcc_toc_witness_relation : "",
          wcc_toc_witness_familyid : "",
        })
      );
  ...
  saveData(value : any){
    if (this.isEdit == true) {
      ...
      this.modal.confirm({
        ...
        nzOnOk: () => {
          this.tocService.updateData(this.transac_id,value).subscribe(async (data: any) => {
            console.log(data);
      ...
      this.modal.confirm({
        ...
        nzOnOk: () => {
          this.tocService.addNew(value).subscribe(async (data: any) => {
            console.log(data);
