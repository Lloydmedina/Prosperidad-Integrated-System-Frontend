...
@Component({
  selector: 'app-osca-intake-print-list',
  templateUrl: './osca-intake-print-list.component.html',
  styleUrls: ['./osca-intake-print-list.component.scss']
})
export class OscaIntakePrintListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.oscaIntakeService.getOscaIntakeGenerated(this.filterValue.filter_type, this.localStorageStatus, this.localStorageDeletedStatus, this.filterValue.thisMonth, this.filterValue.thisYear, this.filterValue.monthly, this.filterValue.monthlyYear, this.filterValue.yearQuarterly, this.filterValue.quarter, this.filterValue.yearly, this.filterValue.from, this.filterValue.to).subscribe(data => {
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "OscaIntake_List_Worksheet.xlsx";
