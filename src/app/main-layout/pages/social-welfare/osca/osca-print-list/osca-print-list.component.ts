...
@Component({
  selector: 'app-osca-print-list',
  templateUrl: './osca-print-list.component.html',
  styleUrls: ['./osca-print-list.component.scss']
})
export class OscaPrintListComponent implements OnInit {
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "OSCA_List_Worksheet.xlsx";
