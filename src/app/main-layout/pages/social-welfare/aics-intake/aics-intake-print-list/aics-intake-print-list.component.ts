...
@Component({
  selector: 'app-aics-intake-print-list',
  templateUrl: './aics-intake-print-list.component.html',
  styleUrls: ['./aics-intake-print-list.component.scss']
})
export class AicsIntakePrintListComponent implements OnInit {
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "AicsIntake_List_Worksheet.xlsx";
