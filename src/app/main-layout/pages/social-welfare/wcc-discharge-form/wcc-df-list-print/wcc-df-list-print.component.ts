...
@Component({
  selector: 'app-wcc-df-list-print',
  templateUrl: './wcc-df-list-print.component.html',
  styleUrls: ['./wcc-df-list-print.component.scss']
})
export class WccDfListPrintComponent implements OnInit {
