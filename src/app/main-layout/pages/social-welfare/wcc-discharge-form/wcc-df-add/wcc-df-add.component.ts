...
@Component({
  selector: 'app-wcc-df-add',
  templateUrl: './wcc-df-add.component.html',
  styleUrls: ['./wcc-df-add.component.scss']
})
export class WccDfAddComponent implements OnInit {
  ...
  proceedToForm(data: any){
    console.log(data);
    this.router.navigate(["/main/social-welfare/wcc-discharge-form/add-form/" + data.main_pk_id])
  }
