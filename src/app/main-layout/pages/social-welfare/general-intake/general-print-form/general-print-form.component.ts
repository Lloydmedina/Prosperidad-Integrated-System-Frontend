...
@Component({
  selector: 'app-general-print-form',
  templateUrl: './general-print-form.component.html',
  styleUrls: ['./general-print-form.component.scss']
})
export class GeneralPrintFormComponent implements OnInit {
  ...
  ngOnInit() {
    this.generalIntakeService.getGeneralIntakeEdit(this.param).subscribe(data => {
      this.data = data;
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "FamilyCompositionIntake_Form_Worksheet.xlsx";
