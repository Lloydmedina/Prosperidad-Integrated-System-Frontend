...
@Component({
  selector: 'app-general-print-list',
  templateUrl: './general-print-list.component.html',
  styleUrls: ['./general-print-list.component.scss']
})
export class GeneralPrintListComponent implements OnInit {
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "GeneralIntake_List_Worksheet.xlsx";
