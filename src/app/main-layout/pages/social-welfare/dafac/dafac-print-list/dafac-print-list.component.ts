...
@Component({
  selector: 'app-dafac-print-list',
  templateUrl: './dafac-print-list.component.html',
  styleUrls: ['./dafac-print-list.component.scss']
})
export class DafacPrintListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.dafacService.getDafacGenerated(this.filterValue.filter_type, this.localStorageStatus, this.localStorageDeletedStatus, this.filterValue.thisMonth, this.filterValue.thisYear, this.filterValue.monthly, this.filterValue.monthlyYear, this.filterValue.yearQuarterly, this.filterValue.quarter, this.filterValue.yearly, this.filterValue.from, this.filterValue.to).subscribe(data => {
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "Dafac_List_Worksheet.xlsx";
