...
@Component({
  selector: 'app-wcciu-add',
  templateUrl: './wcciu-add.component.html',
  styleUrls: ['./wcciu-add.component.scss']
})
export class WcciuAddComponent implements OnInit {
  ...
  proceedToForm(data: any){
    console.log(data);
    this.router.navigate(["/main/social-welfare/wcc-intervention-undertaken/add-form/" + data.main_pk_id])
  }
