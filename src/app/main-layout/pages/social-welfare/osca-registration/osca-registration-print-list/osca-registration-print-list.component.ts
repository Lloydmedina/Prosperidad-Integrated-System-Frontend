...
@Component({
  selector: 'app-osca-registration-print-list',
  templateUrl: './osca-registration-print-list.component.html',
  styleUrls: ['./osca-registration-print-list.component.scss']
})
export class OscaRegistrationPrintListComponent implements OnInit {
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "OSCA_Registered_List_Worksheet.xlsx";
