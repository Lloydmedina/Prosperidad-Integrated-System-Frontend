...
@Component({
  selector: 'app-sp-print-list',
  templateUrl: './sp-print-list.component.html',
  styleUrls: ['./sp-print-list.component.scss']
})
export class SpPrintListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.soloParentService.getSoloParentGenerated(this.filterValue.filter_type, this.localStorageStatus, this.localStorageDeletedStatus, this.filterValue.thisMonth, this.filterValue.thisYear, this.filterValue.monthly, this.filterValue.monthlyYear, this.filterValue.yearQuarterly, this.filterValue.quarter, this.filterValue.yearly, this.filterValue.from, this.filterValue.to).subscribe(data => {
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "PWD_List_Worksheet.xlsx";
