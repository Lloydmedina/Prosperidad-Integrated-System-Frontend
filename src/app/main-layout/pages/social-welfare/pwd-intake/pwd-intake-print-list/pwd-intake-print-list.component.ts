...
@Component({
  selector: 'app-pwd-intake-print-list',
  templateUrl: './pwd-intake-print-list.component.html',
  styleUrls: ['./pwd-intake-print-list.component.scss']
})
export class PwdIntakePrintListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.pwdIntakeService.getPwdIntakeGenerated(this.filterValue.filter_type, this.localStorageStatus, this.localStorageDeletedStatus, this.filterValue.thisMonth, this.filterValue.thisYear, this.filterValue.monthly, this.filterValue.monthlyYear, this.filterValue.yearQuarterly, this.filterValue.quarter, this.filterValue.yearly, this.filterValue.from, this.filterValue.to).subscribe(data => {
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "PWDIntake_List_Worksheet.xlsx";
