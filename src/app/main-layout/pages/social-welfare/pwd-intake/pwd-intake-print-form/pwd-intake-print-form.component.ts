...
@Component({
  selector: 'app-pwd-intake-print-form',
  templateUrl: './pwd-intake-print-form.component.html',
  styleUrls: ['./pwd-intake-print-form.component.scss']
})
export class PwdIntakePrintFormComponent implements OnInit {
  ...
  ngOnInit() {
    this.pwdIntakeService.getPwdIntakeEdit(this.param).subscribe(data => {
      this.data = data;
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "PWDIntake_Form_Worksheet.xlsx";
