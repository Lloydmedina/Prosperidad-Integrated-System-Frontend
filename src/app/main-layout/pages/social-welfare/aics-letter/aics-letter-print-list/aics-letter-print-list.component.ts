...
@Component({
  selector: 'app-aics-letter-print-list',
  templateUrl: './aics-letter-print-list.component.html',
  styleUrls: ['./aics-letter-print-list.component.scss']
})
export class AicsLetterPrintListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.aicsLetterService.getAicsLetterGenerated(this.filterValue.filter_type, this.localStorageStatus, this.localStorageDeletedStatus, this.filterValue.thisMonth, this.filterValue.thisYear, this.filterValue.monthly, this.filterValue.monthlyYear, this.filterValue.yearQuarterly, this.filterValue.quarter, this.filterValue.yearly, this.filterValue.from, this.filterValue.to).subscribe(data => {
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "AICS_Letter_List_Worksheet.xlsx";
