...
@Component({
  selector: 'app-wcc-summary-intake-form-print',
  templateUrl: './wcc-summary-intake-form-print.component.html',
  styleUrls: ['./wcc-summary-intake-form-print.component.scss']
})
export class WccSummaryIntakeFormPrintComponent implements OnInit {
  isLoading = true;
  param: any;
  clientData : any;
  caseCData : any;
  ...
  convertToPDF() {
    ...
    html2canvas(this.dataElement).then(canvas => {
      ...
      pdf.save("WCC_SUMMARY_INTAKE.pdf"); // Generated PDF
    });
  }
