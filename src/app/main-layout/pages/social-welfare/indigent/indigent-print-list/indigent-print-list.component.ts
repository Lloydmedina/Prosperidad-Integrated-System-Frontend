...
@Component({
  selector: 'app-indigent-print-list',
  templateUrl: './indigent-print-list.component.html',
  styleUrls: ['./indigent-print-list.component.scss']
})
export class IndigentPrintListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.indigentService.getIndigentGenerated(this.filterValue.filter_type, this.localStorageStatus, this.localStorageDeletedStatus, this.filterValue.thisMonth, this.filterValue.thisYear, this.filterValue.monthly, this.filterValue.monthlyYear, this.filterValue.yearQuarterly, this.filterValue.quarter, this.filterValue.yearly, this.filterValue.from, this.filterValue.to).subscribe(data => {
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "Indigent_List_Worksheet.xlsx";
