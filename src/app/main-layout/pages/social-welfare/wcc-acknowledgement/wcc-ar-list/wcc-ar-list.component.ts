...
@Component({
  selector: 'app-wcc-ar-list',
  templateUrl: './wcc-ar-list.component.html',
  styleUrls: ['./wcc-ar-list.component.scss']
})
export class WccArListComponent implements OnInit {
  ...
  constructor(
    ...
    private wccARservices : WccAcknowledgementService
  ) { }
  ...
  loadDatas(){
    this.wccARservices.getList().subscribe(data => {
      console.log(data);
  ...
  edit(datas: any) {
   ...
   this.router.navigate(["/main/social-welfare/wcc-acknowledgement/edit-form/" + datas.client_pid +"/"+datas.main_pk_id])
  }
  ...
  print(data : any) {
    ...
    this.router.navigate(["/main/social-welfare/wcc-acknowledgement/form-print/" + data.main_pk_id])
  }
