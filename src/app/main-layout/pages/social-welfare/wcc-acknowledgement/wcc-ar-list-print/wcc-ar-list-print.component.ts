...
@Component({
  selector: 'app-wcc-ar-list-print',
  templateUrl: './wcc-ar-list-print.component.html',
  styleUrls: ['./wcc-ar-list-print.component.scss']
})
export class WccArListPrintComponent implements OnInit {
