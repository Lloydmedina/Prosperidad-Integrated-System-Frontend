...
@Component({
  selector: 'app-sp-intake-print-list',
  templateUrl: './sp-intake-print-list.component.html',
  styleUrls: ['./sp-intake-print-list.component.scss']
})
export class SpIntakePrintListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.spIntakeService.getSoloParentIntakeGenerated(this.filterValue.filter_type, this.localStorageStatus, this.localStorageDeletedStatus, this.filterValue.thisMonth, this.filterValue.thisYear, this.filterValue.monthly, this.filterValue.monthlyYear, this.filterValue.yearQuarterly, this.filterValue.quarter, this.filterValue.yearly, this.filterValue.from, this.filterValue.to).subscribe(data => {
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "SoloParent_Intake_List_Worksheet.xlsx";
