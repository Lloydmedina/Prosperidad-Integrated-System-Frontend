...
@Component({
  selector: 'app-aics-voucher-print-list',
  templateUrl: './aics-voucher-print-list.component.html',
  styleUrls: ['./aics-voucher-print-list.component.scss']
})
export class AicsVoucherPrintListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.aicsVoucherService.getAicsVoucherGenerated(this.filterValue.filter_type, this.localStorageStatus, this.localStorageDeletedStatus, this.filterValue.thisMonth, this.filterValue.thisYear, this.filterValue.monthly, this.filterValue.monthlyYear, this.filterValue.yearQuarterly, this.filterValue.quarter, this.filterValue.yearly, this.filterValue.from, this.filterValue.to).subscribe(data => {
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "AICS_Voucher_List_Worksheet.xlsx";
