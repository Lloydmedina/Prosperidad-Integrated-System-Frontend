...
@Component({
  selector: 'app-wcc-case-conference-add',
  templateUrl: './wcc-case-conference-add.component.html',
  styleUrls: ['./wcc-case-conference-add.component.scss']
})
export class WccCaseConferenceAddComponent implements OnInit {
  ...
  proceedToForm(data : any){
    this.modal.confirm({
      nzTitle : 'Proceed to Case Conference Form?',
      nzOnOk : () =>
      // console.log(data.main_pk_id)
      this.router.navigate(["/main/social-welfare/wcc-case-conference/add-form/" + data.main_pk_id])
    })
  }
