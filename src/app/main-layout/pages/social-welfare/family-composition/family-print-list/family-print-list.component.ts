...
@Component({
  selector: 'app-family-print-list',
  templateUrl: './family-print-list.component.html',
  styleUrls: ['./family-print-list.component.css']
})
export class FamilyPrintListComponent implements OnInit {
  ...
  ngOnInit() {this.localStorageStatus = localStorage.getItem("fc_status")
  ...
  this.familyCompositionService.getFamilyCompositionGenerated(this.filterValue.filter_type, this.localStorageStatus, this.localStorageDeletedStatus, this.filterValue.thisMonth, this.filterValue.thisYear, this.filterValue.monthly, this.filterValue.monthlyYear, this.filterValue.yearQuarterly, this.filterValue.quarter, this.filterValue.yearly, this.filterValue.from, this.filterValue.to).subscribe(data => {
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "FamilyComposition_List_Worksheet.xlsx";
