...
@Component({
  selector: 'app-person-print-list',
  templateUrl: './person-print-list.component.html',
  styleUrls: ['./person-print-list.component.scss']
})
export class PersonPrintListComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.personService.getPersonGenerated(this.filterValue.filter_type, this.localStorageStatus, this.localStorageDeletedStatus, this.filterValue.thisMonth, this.filterValue.thisYear, this.filterValue.monthly, this.filterValue.monthlyYear, this.filterValue.yearQuarterly, this.filterValue.quarter, this.filterValue.yearly, this.filterValue.from, this.filterValue.to).subscribe(data => {
