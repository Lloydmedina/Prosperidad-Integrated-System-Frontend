...
import { TreeNodeInterface } from '../../property-setup/property-setup-list/property-setup-list.component';

@Component({
  selector: 'app-tenant-profiling-print-list',
  templateUrl: './tenant-profiling-print-list.component.html',
  styleUrls: ['./tenant-profiling-print-list.component.css']
})
export class TenantProfilingPrintListComponent implements OnInit {
  ...
  ngOnInit() {
    this.tenantService.getPrintList().subscribe(data => {
