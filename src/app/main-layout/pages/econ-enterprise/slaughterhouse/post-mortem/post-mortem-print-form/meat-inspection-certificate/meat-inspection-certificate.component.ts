...
@Component({
  selector: 'app-meat-inspection-certificate',
  templateUrl: './meat-inspection-certificate.component.html',
  styleUrls: ['./meat-inspection-certificate.component.scss']
})
export class MeatInspectionCertificateComponent implements OnInit {
  ...
  excel() {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        ...
        /* save to file */
        let str = "MeatInspectionCertificate_Form_Worksheet.xlsx";
