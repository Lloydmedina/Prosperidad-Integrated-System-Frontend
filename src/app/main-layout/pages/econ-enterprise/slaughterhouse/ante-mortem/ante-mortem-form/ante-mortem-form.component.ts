...
@Component({
  selector: 'app-ante-mortem-form',
  templateUrl: './ante-mortem-form.component.html',
  styleUrls: ['./ante-mortem-form.component.scss']
})
export class AnteMortemFormComponent implements OnInit {
  ...
  cancel(): void {
    this.router.navigate(['/main/economic-enterprises/slaughterhouse/ante-mortem'])
  }
