...
@Component({
  selector: 'app-sanitary-permit-list',
  templateUrl: './sanitary-permit-list.component.html',
  styleUrls: ['./sanitary-permit-list.component.scss']
})
export class SanitaryPermitListComponent implements OnInit {
  listURL = "/main/health/sanitary-permit"
  addURL = "/main/health/sanitary-permit/add-form"
  newURL = "/main/health/sanitary-permit/add-form/"
  ...
  ngOnInit() {
    ...
    this.loadDatas()
      ...
      this.paymentForm = this.fb.group({
        main_pk_id:' ',
        or_id : ['',[Validators.required]],
        or_date : [null,[Validators.required]],
        payment_status :' ',
        payment_type : [null,[Validators.required]],
        amount_paid : [null,[Validators.min(10)]],
        total_fee:'',
      })
 ...
 proccedToPrintCard( data_id : any) {
  ...
  delete(data : any) {
    this.modal.confirm({
      ...
      nzOnOk: () => {
        this.isLoading = true;
        this.SPservices.deleteTrans(data.sp_pk_id).subscribe( async x =>{
          this.loadDatas()
...
selectedPayment : any
  ...
  edit(data:any){
    ...
    this.router.navigate(["/main/health/sanitary-permit/edit-form/" + data.sp_business_id+"/"+data.sp_pk_id])
  }
}
