...
@Component({
  selector: 'app-health-card-form',
  templateUrl: './health-card-form.component.html',
  styleUrls: ['./health-card-form.component.scss']
})
export class HealthCardFormComponent implements OnInit {
