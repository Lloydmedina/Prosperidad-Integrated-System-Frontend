  ...
  ngOnInit() {
    ...
    this.validateForm = this.fb.group({
      // MEDICAL TRANSACTIONS ------------------
        ...
        lab_exam_date : ['',  [Validators.required]],
...
this.proccedToPrintCard(dataid);
 ...
 proccedToPrintCard( data_id : any) {
  ...
  revert(data : any){
    //console.log(data)
    this.modal.confirm({
      nzTitle: 'Do you Want to revert these transaction?',
      nzOnOk: () => {
        this.healthService.revertTrans(data.pk_id).subscribe( async x =>{
         // console.log(x)
          this.ngOnInit()
...
//console.log()
  ...
  edit(data:any){
    //console.log("DATA", data.pk_id)
   this.router.navigate(["/main/health/health-card-individual/edit-form/" + data.pk_id])
  }
}
