...
@Component({
  selector: 'app-healthcard-business-list-print',
  templateUrl: './healthcard-business-list-print.component.html',
  styleUrls: ['./healthcard-business-list-print.component.scss']
})
export class HealthcardBusinessListPrintComponent implements OnInit {
  ...
  ngOnInit() {
    this.healthService.getHCBusinessList().subscribe( value =>{
      ...
      this.person = this.listOfData[0].personModel;
      console.log(value)
      let i = 0
