...
@Component({
  selector: 'app-clinical-abstract-form',
  templateUrl: './clinical-abstract-form.component.html',
  styleUrls: ['./clinical-abstract-form.component.scss']
})
export class ClinicalAbstractFormComponent implements OnInit {
        ...
        this.dentalservice.getDentalCertificateListById(dataid).subscribe(data => {
          ...
          if (data[0].length === 0) {
            ...
            this.checkPerson(dataid);
                ...
                //this.proccedToAddNewForm(dataid);
        //this.router.navigate(["/"+this.basepath_arr[0]+"/"+this.basepath_arr[1]+"/"+this.basepath_arr[2]+"/"+this.basepath+"/"+dataid]);
