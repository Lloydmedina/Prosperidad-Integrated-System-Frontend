...
@Component({
  selector: 'app-dental-certificate-list-print',
  templateUrl: './dental-certificate-list-print.component.html',
  styleUrls: ['./dental-certificate-list-print.component.scss']
})
export class DentalCertificateListPrintComponent implements OnInit {
