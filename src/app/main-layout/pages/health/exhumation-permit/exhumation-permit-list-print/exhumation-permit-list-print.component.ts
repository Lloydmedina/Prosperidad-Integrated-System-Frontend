...
@Component({
  selector: 'app-exhumation-permit-list-print',
  templateUrl: './exhumation-permit-list-print.component.html',
  styleUrls: ['./exhumation-permit-list-print.component.scss']
})
export class ExhumationPermitListPrintComponent implements OnInit {
  ...
  person : any;
  ngOnInit() {
    this.exServices.getList().subscribe( value =>{
      this.listOfData = value[0];
      this.person = this.listOfData[0].dc_person_data;
